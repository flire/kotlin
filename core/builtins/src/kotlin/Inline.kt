...
public annotation(retention = AnnotationRetention.BINARY) class noinline
...
public annotation(retention = AnnotationRetention.BINARY) class inline(public val strategy: InlineStrategy = InlineStrategy.AS_FUNCTION)
...
public annotation(retention = AnnotationRetention.BINARY) class inlineOptions(vararg val value: InlineOption)
