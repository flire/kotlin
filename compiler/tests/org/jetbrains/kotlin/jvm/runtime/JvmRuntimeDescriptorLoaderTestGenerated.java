...
public class JvmRuntimeDescriptorLoaderTestGenerated extends AbstractJvmRuntimeDescriptorLoaderTest {
    ...
    public static class CompiledJava extends AbstractJvmRuntimeDescriptorLoaderTest {
        public void testAllFilesPresentInCompiledJava() throws Exception {
            JetTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("compiler/testData/loadJava/compiledJava"), Pattern.compile("^(.+)\\.java$"), true, "sam", "kotlinSignature/propagation");
        }
        ...
        public static class KotlinSignature extends AbstractJvmRuntimeDescriptorLoaderTest {
            ...
            public void testAllFilesPresentInKotlinSignature() throws Exception {
                JetTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("compiler/testData/loadJava/compiledJava/kotlinSignature"), Pattern.compile("^(.+)\\.java$"), true, "propagation");
            }
