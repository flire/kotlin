...
public class CandidateResolver(
    ...
    public fun <D : CallableDescriptor, F : D> CallCandidateResolutionContext<D>.
            performResolutionForCandidateCall(task: ResolutionTask<D, F>) {
    ...
    private fun CallCandidateResolutionContext<*>.proceedTypeArguments() = check {
